...
public class Tests {
    public static void main(String[] args) {
        ...
        PriorityQueue<Process> list = new PriorityQueue<Process>((px, py) -> px.getArrivalTime() - py.getArrivalTime());
        list.add(p0);
        list.add(p1);
        list.add(p2);
        ...
        for (Process p : completedQueue) {
            System.out.println("P" + p.getPid() + " = " + p.calcWaitingTime());
        }

        System.out.println("Avg Waiting = " + scheduler.calcAvgWaitingTime());
    }
}
